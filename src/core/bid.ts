...
export type TPrefPlayerBidOrdered = {
	id: number;
	designation: TPrefDesignation;
	bid: EPrefBid;
};

export type TPrefKontras = {
	p1: EPrefKontra;
	p2: EPrefKontra;
	p3: EPrefKontra;
};
export type TPrefPlayerKontra = {
	designation: TPrefDesignation;
	kontra: EPrefKontra;
};
export type TPrefPlayerKontraOrdered = {
	id: number;
	designation: TPrefDesignation;
	kontra: EPrefKontra;
};

export type TPrefPlayerDecision = {
	designation: TPrefDesignation;
	follows: boolean;
};
export type TPrefHandSuggestion = {
